...
def main() -> None:
    ...
    lines = [
        ...
        *[f"| PPO full training, n_envs={k} | {v} |" for k, v in train.items()],
        ...
        "## Reading",
        "",
        "- Batched collection has a break-even env count; compare the",
        "  n_envs rows above before assuming a speedup on your hardware.",
        "- Compare the full-training rows before using n_envs as a",
        "  speedup at small scales: collection gains can be offset by",
        "  optimization dominating and per-column bookkeeping.",
