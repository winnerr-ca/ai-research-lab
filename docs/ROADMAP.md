...
| 3 | **Consolidation pass 1** | Extract from the two working algorithms: env layer (factory, wrappers, vectorization seam, normalization), network library, rollout collector, training engine with fixed hooks | 2 |
